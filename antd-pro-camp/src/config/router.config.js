...
export const asyncRouterMap = [
  {
    ...
    children: [
      // 产品管理
      {
        ...
        redirect: '/product/productInfo',
        component: RouteView,
        meta: { title: '产品管理', keepAlive: true, icon: 'code-sandbox', permission: [ 'dashboard' ] },
        children: [
          // 产品信息
          {
          ...
          // 修改产品
          {
            ...
            name: 'ProductEdit',
            hidden: true,
            component: () => import('@/views/product/productAdd/ProductEdit'),
            meta: { title: '修改产品', target: '_blank', keepAlive: false, hiddenHeaderContent: true, permission: ['dashboard'] }
          },
          // 查看产品
          {
            path: '/product/productShow',
            name: 'ProductShow',
            hidden: true,
            component: () => import('@/views/product/productShow/ProductShow'),
            meta: { title: '查看产品', target: '_blank', keepAlive: false, hiddenHeaderContent: true, permission: ['dashboard'] }
          }
        ]
      },
      // 考试管理
      ...
      // 平台设置
      {
        ...
        component: RouteView,
        meta: { title: '平台', keepAlive: true, icon: 'setting', permission: [ 'dashboard' ] },
        children: [
          // 平台设置
          {
