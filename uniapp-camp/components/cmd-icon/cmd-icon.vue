<template>
	<view v-if="prefixClass==='iconfont'" :class="[prefixClass, type]" :style="setStyle" @tap="$_click"></view>
	<view v-else :class="[prefixClass, prefixClass+'-'+type]" :style="setStyle" @tap="$_click"></view>
</template>
